...
* Различные методы анализа:
    ...
    - [Парсинг данных](https://github.com/AnfisaAnalytics/myProfile/blob/6cf955d91a2dbb843a7c833cd23f7fb5d5df061a/portfolio/03%20-%20Different/3.%20scraping%20_book.ipynb) : в данном ноутбуке анализ не предусмотрен, здесь мы получаем данные из сети и рисуем локальный файл. 
