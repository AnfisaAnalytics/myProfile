...
* Различные методы анализа:
    ...
    - [Парсинг данных](https://github.com/AnfisaAnalytics/myProfile/blob/38bfcd6d5d9c2fed4db9fb9c137f4f08474b7275/portfolio/03%20-%20Different/3.%20scraping%20_book.ipynb) : в данном ноутбуке анализ не предусмотрен, здесь мы получаем данные из сети и рисуем локальный файл.
